...
var Usuario = /*#__PURE__*/function () {
  ...
  _createClass(Usuario, [{
    key: "mostrarSaludo",
    value: function mostrarSaludo(saludo) {
      return "".concat(saludo, " ").concat(this.nombre);
    }
  }, {
    key: "mostrarInfo",
...
var Estudiante = /*#__PURE__*/function (_Usuario) {
  ...
  _createClass(Estudiante, [{
    key: "mostrarInfo",
    value: function mostrarInfo() {
      return "Nombre: ".concat(this.nombre, " Edad: ").concat(this.edad, " Carrera: ").concat(this.carrera);
    }
  }]);
...
var usuario1 = new Usuario('Francisco', 26);
document.write(usuario1.mostrarSaludo('klk'));
document.write('<br>');
document.write(usuario1.mostrarInfo());
document.write('<hr>');
var estudiante1 = new Estudiante('Francisco', 26, 'Ingeniero');
